...
```mermaid
%% C4 Context Diagram: Чат с офлайн-режимом (с веб и мобильным браузером с отправкой писем)

C4Context
    title Чат с офлайн-режимом: Контекстная диаграмма с браузерами и отправкой писем
    ...
    System_Boundary(s1, "Система Чата") {
        ...
        System_Ext(emailService, "Сервис отправки электронных писем", "Отправка письма с подтверждением регистрации")
    }
